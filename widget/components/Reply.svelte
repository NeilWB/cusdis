...
<div class="grid grid-cols-1 gap-4 mb-12">
  <div class="grid grid-cols-2 gap-4">
    <div class="px-1">
      ...
      <input
        name="nickname"
        class="w-full p-2 border border-gray-200 dark:text-gray-100 dark:outline-none"
        type="text"
        title={t('nickname')}
        bind:value={nickname}
      />
  ...
  <div class="px-1">
    ...
    <textarea
      name="reply_content"
      class="w-full p-2 border border-gray-200 h-24 dark:text-gray-100 dark:outline-none"
  ...
  <div class="px-1">
    <button
      ...
      class="button button-submit dark:bg-transparent dark:border dark:border-gray-100"
